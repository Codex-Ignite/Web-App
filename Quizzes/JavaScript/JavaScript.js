...
async function fetchQuizzes() {
  const response = await fetch('JavaScript.json'); // Fetch JavaScript quizzes
...
async function displayQuestion() {
  ...
  const category = "JavaScript";  // Use JavaScript category for this example
...
async function handleSubmit() {
  ...
  const category = "JavaScript";  // Use JavaScript category
  const quiz = quizzes[category][currentQuestionIndex];
  totalQuestions++;
